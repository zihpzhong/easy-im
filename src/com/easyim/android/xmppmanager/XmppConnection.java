package com.easyim.android.xmppmanager;
...
public class XmppConnection {
	...
	public static String SERVER_HOST = "192.168.1.96";//你openfire服务器所在的ip
	public static  String SERVER_NAME = "microsof-482a97";//设置openfire时的服务器名
